...
{
	public abstract class AlancDragRefreshTableSource : UITableViewSource
	{
		...
		protected nfloat needDragDistance = 80;
		public nfloat NeedDragDistance {
			get {
				return needDragDistance;
			}
		}
		...
		public AlancDragRefreshTableSource (List<string> _dataList,Action _refreshAction,Action _addMoreAction)
		{
		...
		public override void DraggingEnded (UIScrollView scrollView, bool willDecelerate)
		{
			...
			if (!isLoading && footerViewActionDis > needDragDistance) LoadMoreData ();
			if (scrollView.ContentOffset.Y < -needDragDistance) {
